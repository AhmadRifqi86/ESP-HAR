            ...
            <>
              ...
              <div className="mt-2 grid gap-1">
                <div className="grid gap-1 grid-cols-2 text-left">
                  ...
                  <div>
                    <Select
                      value={formData.health_data.gluc}
                      onValueChange={(value) => {
                        setFormData({
                          ...formData,
                          health_data: { ...formData.health_data, gluc: value },
                        });
                      }}
                    >
                      <SelectTrigger className="w-full">
              ...
              <div className="grid gap-1 grid-cols-2 text-left">
                ...
                <div>
                  ...
                  <Select
                    value={formData.health_data.gender}
                    onValueChange={(value) => {
                      setFormData({
                        ...formData,
                        health_data: { ...formData.health_data, gender: value },
                      });
                    }}
                  >
                    <SelectTrigger className="w-full">
              ...
              <div className="my-3">
                <div className=" my-2 grid gap-4  sm:grid-cols-1 lg:grid-cols-2 ">
                  <div className="flex items-center">
                    <Switch
                      id="alcohol-intake"
                      checked={formData.health_data.alco === 1}
                  ...
                  <div className="flex items-center">
                    <Switch
                      id="smoking"
                      checked={formData.health_data.smoke === 1}
                      onCheckedChange={(value) => {
                        const number = value ? 1 : 0;
                        setFormData({
                          ...formData,
                ...
                <div className="grid gap-4 lg:grid-cols-2 sm:grid-cols-1">
                  <div className="flex items-center">
                    <Switch
                      ...
                      checked={formData.health_data.active === 1}
                      onCheckedChange={(value) => {
                        const number = value ? 1 : 0;
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex items-center">
                    ...
                    <Label htmlFor="cardiovascular-disease">
